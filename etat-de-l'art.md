...
Notre équipe de recherche a commencé à travailler sur les générateurs de sons FM dans le cadre d’un projet de passage des orgues Electone® aux technologies numériques. Dès 1974, date de commercialisation du synthétiseur analogique Yamaha SY-1, nous avions déjà réalisé un prototype d’instrument intégrant des générateurs numériques travaillant en synthèse FM. Hélas, il était alors impossible de le mettre sur le marché, à cause du nombre impressionnant de circuits intégrés nécessaires, seule technologie disponible alors, et aussi à cause des difficultés d’équilibrer forme et fonctions. À mesure que la technologie des semi-conducteurs avançait, nous avons réussi à créer un instrument dont les caractéristiques nous ont semblé acceptables. En avril 1981, sept ans après le début du développement, Yamaha intégra son premier générateur de sons FM dans l’Electone F-70, un modèle devenu classique. Un mois plus tard, arrivait le GS-1, un clavier conçu pour une utilisation sur scène.
...
Le GS1 n’était pas commercialisé comme un synthétiseur – il ne permettait pas l’édition des sons sur l’instrument lui-même. L’utilisateur gérait les sons par l’intermédiaire de cartouches qui permettaient de modifier la banque de 16 sons que le GS1 pouvait générer. Un périphérique spécifique fut toutefois créé pour permettre la programmation des sons par les développeurs. Toutefois il faut avouer que les difficultés de programmation des sons ont constitué un obstacle de taille dans la réalisation d’un synthétiseur commercialement viable.
